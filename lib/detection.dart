...
import 'package:car_service_management_application/detectionResult.dart';
...
class _DetectionState extends State<Detection> with WidgetsBindingObserver {
  ...
  Future<void> _scanImage() async
  {
    ...
    try
    {
      final ObjectDetector objectDetector = ObjectDetector(
          options: ObjectDetectorOptions(mode: DetectionMode.single, classifyObjects: true, multipleObjects: true)
      );
      ...
      await navigator.push(MaterialPageRoute(builder: (context) => DetectionResult(text: combinedString)));
    }
    catch(e)
    {
      print(e.toString());
